...
get_lava_model <- function(time_horizon,
    ...
    comp.event_coefs=coefs[["comp.event_coef"]]
    baseline_coefs=coefs[["baseline_coef"]]
    timevar_coefs=coefs[["timevar_coef"]]
    censoring_coefs=coefs[["censoring_coef"]]
    regimen_coefs=coefs[["regimen_coef"]]
